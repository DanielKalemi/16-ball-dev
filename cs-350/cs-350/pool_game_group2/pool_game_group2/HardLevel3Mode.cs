...
{
    public partial class HardLevel3Mode : Form
    {
        private GameToolsLevel3 _gameTools;
        public WhiteBall _whiteball = new WhiteBall();
        //------------------------------------------------------------
        //public float Xaxis { get; private set; }
        //public float Yaxis { get; private set; }
        //------------------------------------------------------------
        public HardLevel3Mode()
        {
            InitializeComponent();
            SetStyle(ControlStyles.OptimizedDoubleBuffer, true);
            this._gameTools = new GameToolsLevel3(this.pictureBoxLevel3.Width, this.pictureBoxLevel3.Height);
