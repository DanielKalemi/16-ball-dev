...
namespace pool_game_group2
{
    public class GameToolsLevel2
    {
        ...
        private List<Balls> ResetGame()
        {
            return new List<Balls>()
            {
               // Middle line (4 balls)
                ...
                new Pockets(){DefX = 675, DefY = 50 },
                new Pockets(){DefX = 1200, DefY = 50 },

                new Pockets(){DefX = 40, DefY = 560 },
                new Pockets(){DefX = 675, DefY = 560 },
                new Pockets(){DefX = 1200, DefY = 560 },
            };
        }
        ...
        private int _height;
        //------------------------------------------------------------
        public GameToolsLevel2(int width, int height)
        {
