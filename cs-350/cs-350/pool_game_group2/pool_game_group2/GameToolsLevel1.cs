    ...
    public class GameToolsLevel1
    {
        ...
        private List<Balls> ResetGame()
        {
            return new List<Balls>()
            {
                ...
                new Pockets(){DefX = 40, DefY = 50 },
                new Pockets(){DefX = 430, DefY = 50 },
                new Pockets(){DefX = 860, DefY = 50 },
                new Pockets(){DefX = 1220, DefY = 50 },

                new Pockets(){DefX = 40, DefY = 575 },
                new Pockets(){DefX = 430, DefY = 575 },
                new Pockets(){DefX = 860, DefY = 575 },
                new Pockets(){DefX = 1220, DefY = 575 },

                new Pockets(){DefX = 1220, DefY = 300},
                new Pockets(){DefX = 40, DefY = 300},
            };
        }
        //------------------------------------------------------------
        private int _width;
        private int _height;
        //------------------------------------------------------------
        public GameToolsLevel1(int width, int height)
        {
